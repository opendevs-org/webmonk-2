...
const authRoutes = require('./router/auth.js'); //NOTE: Importing the authRoutes route as a module
const booksRoutes = require('./router/books.js'); //NOTE: Importing the booksRoutes route as a module
...
app.use('/api/books', authenticateJWT, booksRoutes); //NOTE: two middlewares registered on the route one after another, this is known as middleware chaining, it is executed in sequential order
