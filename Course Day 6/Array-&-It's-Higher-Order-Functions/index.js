...
// const results = persons.filter(person => person.age >= 18);
...
// console.log(intArr.reduce((result, currentValue) => result + currentValue));
...
// myFun("one", "two", "three", "four", "five", "six", 7, 8, {
//     name: "Alok",
//     age: 23
// })